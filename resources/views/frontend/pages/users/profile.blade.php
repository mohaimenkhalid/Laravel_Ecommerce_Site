                   ...
                   @include('admin.partials.message-success')
                    ...
                    <form method="POST" action="{{ route('user.profile.update') }}">
                            ...
                            <div class="col-md-6">
                                <select class="form-control" name="division_id">
                                    ...
                                    <option class="form-control" value="{{ $division->id }}" 
                                    	 <?php if ($user->division_id == $division->id): ?>
                                   <?php echo 'selected'; ?>
                        			<?php endif ?>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <select class="form-control" name="district_id">
                                    ...
                                    <option class="form-control" value="{{ $district->id }}"

                                   <?php if ($user->district_id == $district->id): ?>
                                   <?php echo 'selected'; ?>
                        			<?php endif ?>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <textarea id="shipping_address"   class="form-control{{ $errors->has('shipping_address') ? ' is-invalid' : '' }}" name="shipping_address"  rows="4" >
